...
class NewAdmin extends Component {
    ...
    handleSubmit = (event) =>{
        ...
        if(this.state.firstName.length !==0 && this.state.lastName.length !== 0 && this.state.email.length !==0 && this.state.password.length !== 0){
            axios.post('https://moviereview-raj.herokuapp.com/api/admin', userData, config)
        .then(result =>{
        ...
        return (
            <Grid container>
                ...
                <Grid item sm>
                    ...
                    <Typography variant="h3" className={classes.pageTitle}>Admin SignUp</Typography>
                    ...
                    <TextField 
                        ...
                        <Button
                            ...
                            <br />
                            <small>Already have an account? <Link to={`/login/admin`}>Login</Link></small>
                    </form>
                    </div>
                </Grid>
                <Grid item sm />
